...
public struct BurgerMenu_Cross: View {
    public init(menuState: Binding<Bool>, size: CGFloat = 24, burgerColor: Color = .black, crossColor: Color = .black, duration: CGFloat = 0.5, isRounded: Bool = false) {
